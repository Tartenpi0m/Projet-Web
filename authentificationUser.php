...
<body>
    ...
    <div style="border:ridge 5px black; margin: 0 auto; width:max-content; padding: 1em; padding-top: 0;">
        <p style="font-size: xx-large; text-align: center; margin-top:10px;">User Authentification</p>
    ...
    if (isset($_POST["identifiant"])) {
        ...
        //formuler la requête
        $query = "SELECT identifiant, pass FROM client WHERE identifiant LIKE \"$login\"  ";
        ...
        }//if not destroy session (si sessions créer dans la page d'accueil)
    }
    ?>    
